...
def plot_results(args):
    ...
    plt.tight_layout()
    plt.plot()
    plt.savefig('/home/liuzhuangzhuang/pycharm_P/'+'{}model_comparison'.format(taxonomy_level) + time.strftime('%m%d_%H%M%S', time.localtime(time.time())) + '.jpg')
