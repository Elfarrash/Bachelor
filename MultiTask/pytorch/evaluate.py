...
from MultiTask.pytorch.pytorch_utils import forward
from MultiTask.utils.utilities import write_submission_csv
from MultiTask.utils.utilities import inverse_scale
from MultiTask.utils.utilities import get_labels
...
class Evaluator(object):
    ...
    def evaluate(self, data_type, submission_path=None, 
        ...
        if self.taxonomy_level=="fine":
            output = output_dict['output1']
        elif self.taxonomy_level=="coarse":
