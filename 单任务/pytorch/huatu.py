...
import numpy as np
import yaml
with open(r'C:\Users\AHMED\Desktop\Bach\dcase-ust-taxonomy.yaml') as file:
    batch_data_dict = yaml.load(file, Loader=yaml.FullLoader)
...
n = []
if batch_data2_dict.taxonomy_level == 'coarse':
    ...
    for i, l in enumerate(batch_data2_dict['coarse_target']):
        ...
        for j in range(0, 8):
            ...
            if k == 8:
                n.append(i)
if batch_data2_dict.taxonomy_level == 'fine':
